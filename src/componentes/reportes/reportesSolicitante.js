...
function ReportesSolicitante() {
    ...
    const [criterios, setCriterio] = useState([
        ...
        { id: 5, nombre: 'Consultar Solicitudes atedidos en cada unidad complementaria' }])
    ...
    const inicio = async () => {
        // let ini = ini 
        try {
            await axios.post(URL + '/solicitudS/datoGraficos', { ini: ini, fin: fin }).then(json => {

                console.log(json.data[2], 'fecha del data')
                for (let i = 1; i <= dias; i++) {
                    let dia = i
                    if (i < 10) {
                        dia = '0' + i
    ...
    const inicioInput = async (ini, fin) => {
        ...
        try {
            await axios.post(URL + '/solicitudS/datoGraficos', { ini: ini, fin: fin }).then(json => {
                ...
                // console.log(new Date(fin).getDate(), 'cantidad de dias')
    ...
    try {
        ...
        const cargarData = () => {
            ...
            if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                axios.post(URL + '/solicitudS/reportes', { ini: ini, fin: fin }).then(json => {
        ...
        const listar = async () => {
            ...
            if (idCriterio.valido === 'true') {
                if (idCriterio.campo == 1) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudS/reportes', { ini: fechaIni.campo, fin: fechaFin.campo }).then(json => {
                            setListaSeguro(json.data[0])
                            setCantidad(json.data[1])
                            setData(json.data[1])
                            setServicioReportes(json.data[2])
                ...
                if (idCriterio.campo == 2) {
                    ...
                    if (idSeguro.valido === 'true' && fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudS/reportes1', { ini: fechaIni.campo, fin: fechaFin.campo, idSeguro: idSeguro.campo }).then(json => {
                ...
                if (idCriterio.campo == 3) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudS/reportesSA', { ini: fechaIni.campo, fin: fechaFin.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
                            setTotal(json.data.length)
                            inicio()
                ...
                if (idCriterio.campo == 4) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudS/reportesCA', { ini: fechaIni.campo, fin: fechaFin.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
                ...
                if (idCriterio.campo == 5) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true' && idServicio.valido === 'true') {
                        await axios.post(URL + '/solicitudS/reportesS', { ini: fechaIni.campo, fin: fechaFin.campo, idServicio: idServicio.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
...
export default ReportesSolicitante;

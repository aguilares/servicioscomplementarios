...
function ReportesEncargadoSP() {
    ...
    const [criterios, setCriterio] = useState([
        ...
        { id: 3, nombre: 'Consultar Solicitudes no autorizados' }, { id: 4, nombre: 'Consultar Solicitudes autorizados' },
        { id: 5, nombre: 'Consultar Solicitudes atedidos en cada unidad complementaria' }, { id: 6, nombre: 'listar por Medico solicitante' }])
    ...
    const inicio = async () => {
        try {
            await axios.post(URL + '/solicitudA/datoGraficos', { ini: ini, fin: fin }).then(json => {
    ...
    try {
        ...
        const cargarData = () => {
            setFechaIni({ campo: ini, valido: 'true' })
            setFechaFin({ campo: fin, valido: 'true' })
            if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                axios.post(URL + '/solicitudA/reportes', { ini: ini, fin: fin }).then(json => {
        ...
        const listar = async () => {
            ...
            if (idCriterio.valido === 'true') {
                if (idCriterio.campo == 1) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudA/reportes', { ini: fechaIni.campo, fin: fechaFin.campo }).then(json => {
                            setListaSeguro(json.data[0])
                            setCantidad(json.data[1])
                            setData(json.data[1])
                            setServicioReportes(json.data[2])
                ...
                if (idCriterio.campo == 2) {
                    ...
                    if (idSeguro.valido === 'true' && fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudA/reportes1', { ini: fechaIni.campo, fin: fechaFin.campo, idSeguro: idSeguro.campo }).then(json => {
                ...
                if (idCriterio.campo == 3) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudA/reportesSA', { ini: fechaIni.campo, fin: fechaFin.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
                            setTotal(json.data.length)
                            inicio()
                        })
                    } else toast.error('Seleccione correctamente el intevalos de fechas')
                }
                if (idCriterio.campo == 4) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudA/reportesCA', { ini: fechaIni.campo, fin: fechaFin.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
                ...
                if (idCriterio.campo == 5) {
                    if (fechaIni.valido === 'true' && fechaFin.valido === 'true' && idServicio.valido === 'true') {
                        await axios.post(URL + '/solicitudA/reportesS', { ini: fechaIni.campo, fin: fechaFin.campo, idServicio: idServicio.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
                ...
                if (idCriterio.campo == 6) {
                    if (idMedico.valido === 'true' && fechaIni.valido === 'true' && fechaFin.valido === 'true') {
                        await axios.post(URL + '/solicitudA/reportesMedico', { ini: fechaIni.campo, fin: fechaFin.campo, idMedico: idMedico.campo }).then(json => {
                            setCantidad(json.data)
                            setData(json.data)
                            setTotal(json.data.length)
                            inicio()
...
export default ReportesEncargadoSP;
